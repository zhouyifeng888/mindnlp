...
# ============================================
""" Testing suite for the Mindspore PVT Model. """
...
if is_mindspore_available():
    ...
    from mindnlp.transformers import PvtConfig, PvtForImageClassification, PvtImageProcessor, PvtModel
...
class PvtModelTest(ModelTesterMixin, unittest.TestCase):
    all_model_classes = (PvtForImageClassification,)
...
class PvtModelIntegrationTest(unittest.TestCase):
    ...
    def test_inference_image_classification(self):
        ...
        image_processor = PvtImageProcessor.from_pretrained(
    ...
    def test_inference_fp16(self):
        ...
        """
        model = PvtForImageClassification.from_pretrained(
            "Zetatech/pvt-tiny-224", ms_dtype=ms.float16)
